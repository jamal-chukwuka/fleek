...
//   // ✅ Handle file selection and convert to previews + Base64
//   const onSelectFiles = (e: ChangeEvent<HTMLInputElement>) => {
//     const selected = e.target.files;
//     if (!selected) return;

//     const fileArray = Array.from(selected).slice(0, 3); // limit to 3 photos
//     setFiles(fileArray);
...
//       resolve(canvas.toDataURL('image/jpeg', 0.7)); // compress to JPEG at 70% quality
//     };
...
//   // ✅ Upload images as Base64 strings into Firestore (no Storage needed!)
...
//         // ✅ Use your resizeImage function directly here!
//         const base64String = await resizeImage(file); 
  
//         console.log('Base64 string generated:', base64String.substring(0, 100)); // Preview part of the string
//         console.log('Trying to add to Firestore...');
  
//         await addDoc(collection(db, 'listings'), {
//           photoBase64: base64String,           // ✅ Save resized Base64 image here
//           createdAt: serverTimestamp(),       // ✅ Save upload time
//         });
  
//         console.log('Successfully added to Firestore!');
//       }
  
//       navigate('/for-you'); // ✅ Only navigate if successful!
//     } catch (error) {
